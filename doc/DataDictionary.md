...
| ntas data - returned by API | system_message_type | State of the API                                                                                      | Normal              | Typically returns value of normal - be worried if it does not                                                                                                                                                                                                                                                                                                                                                                                                     |                                                                                 |
...
| ntas data - returned by API | traindirection      | The direction the incoming train is heading                                                           | North               | Takes on four values:  North, south, east, or west                                                                                                                                                                                                                                                                                                                                                                                                                | What does it mean when the station ID is Union and the train dirction is South? |
